...
with lcolumn:
    st.image(r"C:\Users\allek\OneDrive\Documents\Pictures\Screenshots 1\Screenshot 2026-07-06 153552.png",
             use_container_width=True)
    st.link_button("Click Here to Play! 🎮", "https://2753628.playcode.io/")
    st.write("##")
    st.image(r"C:\Users\allek\OneDrive\Documents\Pictures\Screenshots 1\Screenshot 2026-07-06 163126.png",
             use_container_width=True)
    st.link_button("Click Here to Play! 🎮", "https://2753651.playcode.io")
with mcolumn:
    st.image(r"C:\Users\allek\OneDrive\Documents\Pictures\Screenshots 1\Screenshot 2026-07-06 160841.png",
             use_container_width=True)
    st.link_button("Click Here to Play! 🎮", "https://2753647.playcode.io")
    st.image(r"C:\Users\allek\OneDrive\Documents\Pictures\Screenshots 1\Screenshot 2026-07-06 180938.png",
             use_container_width=True)
...
with rcolumn:
    st.image(r"C:\Users\allek\OneDrive\Documents\Pictures\Screenshots 1\Screenshot 2026-07-06 162543.png",
             use_container_width=True)
    st.link_button("Click Here to Play! 🎮", "https://2753649.playcode.io")
    st.image(r"C:\Users\allek\OneDrive\Documents\Pictures\Screenshots 1\Screenshot 2026-07-06 181234.png",
             use_container_width=True)
